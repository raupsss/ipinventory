    ...
    <div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
        <ul class="easyui-tree">
            <li data-options="iconCls:'icon-surat_perintah'">
                <a href="<?php echo base_url(); ?>index.php/pengguna">User</a>
            </li>
            <li data-options="iconCls:'icon-surat_keputusan'">
                <a href="<?php echo base_url(); ?>index.php/barang">Data Barang</a>
            </li>
            ...
            <li data-options="iconCls:'icon-surat_keluar'">
                <a href="<?php echo base_url(); ?>index.php/absensi">absensi</a>
            </li>
            </li>
            <li data-options="iconCls:'icon-surat_keluar'">
...
<div title="Stok Barang" data-options="iconCls:'icon-tip'" style="overflow:auto;padding:5px 0px;">
    <div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
        <ul class="easyui-tree">
            <li>
...
<div title="Laporan" data-options="iconCls:'icon-print'" style="overflow:auto;padding:5px 0px;">
    <div title="TreeMenu" data-options="iconCls:'icon-search'" style="padding:0px;">
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php echo base_url(); ?>index.php/lap_beli">Lap. Pembelian</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url(); ?>index.php/lap_jual">Lap. Penjualan</a></span>
            </li>
            <li>
                <span><a href="<?php echo base_url(); ?>index.php/lap_barang">Lap. Stok Barang</a></span>
            </li>
        </ul>
    </div>
</div>
        ...
        <ul class="easyui-tree">
            <li>
                <span><a href="<?php //echo base_url();
                                ?>index.php/grafik_beli">Pembelian</a></span>
            </li>
            <li>
                <span><a href="<?php //echo base_url();
                                ?>index.php/grafik_jual">Penjualan</a></span>
            </li>
        </ul>
    </div>
</div>