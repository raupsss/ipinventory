        ...
        <table id="dataTable" width="100%">
            ...
            ?>
                    <tr>
                        ...
                        <td align="center" width="200"><?php echo $db['nim']; ?></td>
                        ...
                        <td align="center" width="80">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/mahasiswa/hapus/<?php echo $db['nim']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
